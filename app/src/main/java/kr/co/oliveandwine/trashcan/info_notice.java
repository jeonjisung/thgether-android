...
import kr.co.oliveandwine.trashcan.Adapter.ExpandableListAdapter;
...
//        data.add(new ExpandableListAdapter.Item(ExpandableListAdapter.CHILD, "질문 2-1"));
        ...
        data.add(notice1);
        ExpandableListAdapter.Item notice2 = new ExpandableListAdapter.Item(ExpandableListAdapter.HEADER, "후원 및 협업 문의");
        notice2.invisibleChildren = new ArrayList<>();
        notice2.invisibleChildren.add(new ExpandableListAdapter.Item(ExpandableListAdapter.CHILD, "후원 및 협업 문의 : ansfk87@naver.com"));
        data.add(notice2);
        ExpandableListAdapter.Item notice3 = new ExpandableListAdapter.Item(ExpandableListAdapter.HEADER, "'쓰게더' v1.0 정식 출시");
        notice3.invisibleChildren = new ArrayList<>();
        notice3.invisibleChildren.add(new ExpandableListAdapter.Item(ExpandableListAdapter.CHILD, "'쓰게더' v1.0이 정식 출시 되었습니다."));
        data.add(notice3);
